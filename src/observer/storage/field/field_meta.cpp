...
const static char* FIELD_TYPE = "type";
const static char* FIELD_OFFSET = "offset";
const static char* FIELD_LEN = "len";
const static char* FIELD_VISIBLE = "visible";
const static char* FIELD_NULLABLE = "nullable";
